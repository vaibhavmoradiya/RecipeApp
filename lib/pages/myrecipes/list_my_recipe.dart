...
class _ListMyRecipeState extends State<ListMyRecipe> {
  ...
  Widget build(BuildContext context) {
    ...
    return new Scaffold(
      body: StreamBuilder(
        stream: Firestore.instance.collection('users').document(widget.id).collection('mycolrecipes').snapshots(),
                      ...
                      children: <Widget>[
                        ...
                        IconButton(
                          ...
                          onPressed: () {
                            ...
                            Firestore.instance
                                .collection('users/$userID/mycolrecipes')
                            ...
                            FirebaseStorage.instance
                                .ref()
                                .child(
                                'users/$userID/mycolrecipes/${document['name'].toString()}.jpg')
                                .delete()
                                .then((onValue) {
                              print('deleted photo');
                            });
